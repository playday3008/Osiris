...
static void from_json(const json& j, Config::Aimbot& a)
{
    ...
    read<value_t::boolean>(j, "Jump Check", a.jumpCheck);
...
static void from_json(const json& j, Config::Triggerbot& t)
{
    ...
    read_number(j, "Max aim inaccuracy", t.maxAimInaccuracy);
    read_number(j, "Max shot inaccuracy", t.maxShotInaccuracy);
}
...
static void from_json(const json& j, Config::Visuals& v)
{
    ...
    read<value_t::boolean>(j, "Inverse ragdoll gravity Custom", v.inverseRagdollGravityCustomize);
    read_number(j, "Inverse ragdoll gravity Value", v.inverseRagdollGravityValue);
    read<value_t::boolean>(j, "Physics Timescale", v.ragdollTimescale);
    read_number(j, "Physics Timescale Value", v.ragdollTimescaleValue);
    ...
    read<value_t::boolean>(j, "Show velocity Custom", v.showvelocityM);
    read_number(j, "Show velocity Pos X", v.showvelocityPosX);
    ...
    read<value_t::boolean>(j, "Full Bright", v.fullBright);
    ...
    read_number(j, "Hit marker damage indicator Dist", v.hitMarkerDamageIndicatorDist);
    read_number(j, "Hit marker damage indicator Text X", v.hitMarkerDamageIndicatorTextX);
    read_number(j, "Hit marker damage indicator Text Y", v.hitMarkerDamageIndicatorTextY);
    read_number(j, "Hit marker damage indicator Ratio", v.hitMarkerDamageIndicatorRatio);
...
static void from_json(const json& j, Config::Misc& m)
{
    ...
    read_number(j, "Max hits", m.bhopMaxHits);
    ...
    read<value_t::boolean>(j, "Chat spam", m.chatSpam);
    read<value_t::boolean>(j, "Chat spam random", m.chatSpamRandom);
    read_number(j, "Chat spam delay", m.chatSpamDelay);
    ...
    read<value_t::boolean>(j, "Jump Bug", m.jumpbug);
    read_number(j, "Jump Bug Key", m.jumpbugkey);
    read<value_t::boolean>(j, "Jump Bug Hold", m.jumpbughold);
    ...
    read<value_t::boolean>(j, "Fake Item", m.fakeItem);
    read_number(j, "Fake Item Team", m.fakeItemTeam);
    read_number(j, "Fake Item Message Type", m.fakeItemMessageType);
    read_number(j, "Fake Item Type", m.fakeItemType);
    read_number(j, "Fake Item Rarity", m.fakeItemRarity);
    read_number(j, "Fake Item Player Color", m.fakeItemPlayerColor);
    ...
    read<value_t::boolean>(j, "Bomb Damage Indicator", m.bombDamage);
    ...
    read<value_t::boolean>(j, "Choked packets Ping Based", m.pingBasedChoked);
    ...
    read<value_t::boolean>(j, "Custom Viewmodel", m.customViewmodelToggle);
    read_number(j, "Custom Viewmodel X", m.viewmodel_x);
    read_number(j, "Custom Viewmodel Y", m.viewmodel_y);
    read_number(j, "Custom Viewmodel Z", m.viewmodel_z);
    ...
    read_number(j, "Player Blocker Key", m.playerBlockerKey);
    read<value_t::boolean>(j, "Fix tablet signal", m.fixTabletSignal);
