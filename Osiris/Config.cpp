...
void Config::load(size_t id) noexcept
{
...

    {
        ...
        if (miscJson.isMember("Custom Viewmodel Toggle")) misc.customViewmodelToggle = miscJson["Custom Viewmodel Toggle"].asBool();
        ...
        if (miscJson.isMember("Custom Viewmodel X Knife")) misc.viewmodel_x_knife = miscJson["Custom Viewmodel X Knife"].asFloat();
...
void Config::save(size_t id) const noexcept
{
...

    {
        ...
        miscJson["Custom Viewmodel Toggle"] = misc.customViewmodelToggle;
        ...
        miscJson["Custom Viewmodel Knife Toggle"] = misc.customViewmodelKnifeToggle;
        miscJson["Custom Viewmodel Knife Enabled"] = misc.customViewmodelKnifeEnabled;
        miscJson["Custom Viewmodel Knife Switch"] = misc.customViewmodelMenuSwitch;
        miscJson["Custom Viewmodel Switch Hand"] = misc.customViewmodelSwitchHand;
        miscJson["Custom Viewmodel Switch Hand Knife"] = misc.customViewmodelSwitchHandKnife;
        miscJson["Custom Viewmodel X Knife"] = misc.viewmodel_x_knife;
        miscJson["Custom Viewmodel Y Knife"] = misc.viewmodel_y_knife;
